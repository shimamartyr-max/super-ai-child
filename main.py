...
def memory():
    try:
        ...
        <style>body{background:#0a0a0a;color:#e0e0e0;font-family:Tahoma;padding:20px;}
...
def stats():
    try:
        ...
        <style>body{{background:#0a0a0a;color:#e0e0e0;font-family:Tahoma;text-align:center;padding:20px;}}
